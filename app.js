      ...
      <div class="empty-state" id="emptyState">
        <div class="empty-illustration">
          <svg class="empty-svg" viewBox="0 0 120 100" fill="none">
            <rect x="20" y="30" width="80" height="55" rx="8" stroke="#c7d2fe" stroke-width="2" stroke-dasharray="4 4"/>
            <path d="M50 55h20M50 65h14" stroke="#c7d2fe" stroke-width="2" stroke-linecap="round"/>
            <circle cx="60" cy="25" r="8" fill="#e0e7ff" stroke="#818cf8" stroke-width="1.5"/>
            <path d="M57 25l2 2 4-4" stroke="#6366f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
